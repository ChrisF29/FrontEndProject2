        ...
        for (let option of a.result.options)
          if (match = matcher.match(option.label)) {
            ...
            if (typeof option.section == "object" && option.section.rank === "dynamic") {
              let { name: name3 } = option.section;
              if (!dynamicSectionScore)
                dynamicSectionScore = /* @__PURE__ */ Object.create(null);
              dynamicSectionScore[name3] = Math.max(score2, dynamicSectionScore[name3] || -1e9);
            }
          }
      }
    }
...
var autoCloseTags = EditorView.inputHandler.of((view, from, to, text, defaultInsert) => {
  ...
  let closeTags = state.changeByRange((range) => {
    ...
    if (state.doc.sliceString(head - 1, head) != text || around.name == "JSXAttributeValue" && around.to > head) ;
      ...
      if (base2 && empty.from == head - 2 && ((name3 = elementName(state.doc, base2.firstChild, head)) || ((_a2 = base2.firstChild) === null || _a2 === void 0 ? void 0 : _a2.name) == "JSXFragmentTag")) {
        let insert = `${name3}>`;
...
//# sourceMappingURL=chunk-MANDC2OG.js.map
